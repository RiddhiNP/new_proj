    ...
    function update(val) {
        ...
        // alert($var);
         ...
         if ($flag == 0) {
            ...
            //  alert($option1);
            //  var id=1;
            var data1 = { 'question': $question, 'Answer': $option4,'option1': $option1, 'option2': $option2, 'option3': $option3  };
            $.ajax({
...
function add(e) {
    ...
    var data1 = { 'question': $question, 'Answer': $option1, 'option1': $option2, 'option2': $option3, 'option3': $option4 };
    $.ajax({
        url: "http://localhost:3000/" + $category,
        method: "POST",
        data: data1,
